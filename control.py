...
print G+"\n\t          Andriod ! how can to  create payload for hack any android"
slowprint (R+"\n\t                 .:9nas_007:."+O+"Giant's_Ps Team"+O)
print W+"                  https://www.facebook.com/Giants.ps.officiall/"
print ('\033[96m[1].\033[97mhack android with payload 	APK ')
print ('\033[96m[2]..\033[97mhack android with url ')
print ('\033[96m[3]...\033[97mhack android stagefright_mp4 URL')
print ('\033[96m[4]....\033[97mMerge and encrypt Payload Clean ')
